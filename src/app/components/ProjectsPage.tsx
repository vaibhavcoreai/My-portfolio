                ...
                <div className="max-w-6xl w-full">
                    ...
                    >
                        ...
                        <div className="mb-16">
                            ...
                            >
                                Real applications and websites I've built to apply my skills and create value.
                            </motion.p>
                        </div>
                        ...
                        {actualProjectsData.length < 4 && (
                            <motion.div
                                initial={{ opacity: 0, y: 40 }}
                                whileInView={{ opacity: 1, y: 0 }}
                                viewport={{ once: true }}
                                transition={{ duration: 0.6, delay: actualProjectsData.length * 0.1 }}
                                className="mt-12 p-12 border-2 border-dashed border-black/20 rounded text-center"
                            >
                                <p className="text-sm tracking-[0.2em] uppercase text-neutral-600 mb-2">
                                    More Projects
                                </p>
